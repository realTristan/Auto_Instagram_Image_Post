import autoit, os, time, chromedriver_autoinstaller
...
def main():
    ...
    try: driver.implicitly_wait(2); driver.find_element_by_xpath("//a[contains(text(),'Not Now')]").click()
    except: driver.implicitly_wait(2); driver.find_element_by_xpath("//button[contains(text(),'Not Now')]").click()

    try: driver.implicitly_wait(5); driver.find_element_by_xpath("//button[contains(text(),'Cancel')]").click()
    except: print(Style.BRIGHT + Fore.RED + "[LOG] FAILED TO LOG IN" + Fore.BLUE)
